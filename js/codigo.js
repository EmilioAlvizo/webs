...
function setLightMode() {
    document.querySelector("html").classList.add("tema-claro"),
        document.querySelector("html").classList.remove("tema-oscuro"),
        saveThemeInLocalStorage("light"),
        console.info("Light mode activated.")
}
function setDarkMode() {
    document.querySelector("html").classList.add("tema-oscuro"),
        document.querySelector("html").classList.remove("tema-claro"),
...
setInitialTheme(),
    ...
    let sidebar = document.querySelector(".menur");
    let sidebarBtn = document.querySelector(".fa-xmark");
    console.log(sidebarBtn);
    console.log(sidebar);
    sidebarBtn.addEventListener("click", () => {
        sidebar.classList.toggle("close");
    });
    let sidebarBtn2 = document.querySelector(".fa-bars");
